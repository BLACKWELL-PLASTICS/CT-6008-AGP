...
{
    //messages op cdoes used to identify them
    KEEP_ALIVE = 1,
    WELCOME = 2,
    UNWELCOME = 3,
    OTHER_CONNECTED = 4,
...
public static class NetUtility
{
    public static void OnData(DataStreamReader a_stream, NetworkConnection a_connection, Server a_server = null)
    {
        ...
        switch (opCode)
        {
            ...
            case ServerOpCode.FINISHED:
                ...
                break;
            case ServerOpCode.AI_SPAWN:
                msg = new NetAISpawn(a_stream);
                break;
            default:
    ...
    public static Action<NetMessage> C_AI_SPAWN;
    ...
    public static Action<NetMessage, NetworkConnection> S_AI_SPAWN;
}
